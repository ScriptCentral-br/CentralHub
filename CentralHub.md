                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy Script Hub  Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
local Tabs = {
    ...
    Stats = Window:AddTab({ Title = "Stats", Icon = "rbxassetid://1039287808855157" }),
...
setclipboard("Script Hub Is The Best")
...
Tabs.Main:AddButton({
        Title = "Script Hub Discord Server",
...
Fluent:Notify({
    Title = "Script Hub",
    Content = "Thanks For Using Script Hub",
    Duration = 8
})
